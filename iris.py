...
def box_plot():
    ...
    sns.boxplot(x='species', y='petal length (cm)', data=iris_df, hue='species', palette=palette, ax=axes[0, 0], legend=False)
    axes[0, 0].set_title('Comprimento da Pétala por Espécie')

    # BoxPlot para 'petal width (cm)'
    sns.boxplot(x='species', y='petal width (cm)', data=iris_df, hue='species', palette=palette, ax=axes[0, 1], legend=False)
    axes[0, 1].set_title('Largura da Pétala por Espécie')

    # BoxPlot para 'sepal length (cm)'
    sns.boxplot(x='species', y='sepal length (cm)', data=iris_df, hue='species', palette=palette, ax=axes[1, 0], legend=False)
    axes[1, 0].set_title('Comprimento da Sépala por Espécie')

    # BoxPlot para 'sepal width (cm)'
    sns.boxplot(x='species', y='sepal width (cm)', data=iris_df, hue='species', palette=palette, ax=axes[1, 1], legend=False)
